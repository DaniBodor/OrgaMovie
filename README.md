...
- whether or not to duplicate ROIs to the other screen
    - this is useful for movies generated by above macro, where one organoid is displayed twice (left and right) with separate color coding
- which (mitotic) stages to keep track of
- whether you want to score your observations
    - uncheck this if you only want to keep track of timing
